...
function TodoItems({ items, fetchItems }) {
    ...
    const toggleComplete = async (itemId) => {
        try {
            const response = await fetch(`http://localhost:5000/auth/iscomplete/${itemId}`, {
                method: "PUT",
            });
    ...
    const deleteItem = async (itemId) => {
        try {
            const response = await fetch(`http://localhost:5000/auth/delete/${itemId}`, {
                method: "DELETE",
            });
    ...
    const handleUpdate = async (itemId) => {
        try {
            const response = await fetch(`http://localhost:5000/auth/update/${itemId}`, {
                method: "PUT",
                headers: {
