...
function TodoItems({ items, fetchItems }) {
    ...
    const toggleComplete = async (itemId) => {
        try {
            const response = await fetch(`https://to-do-list-j6cu.onrender.com/auth/iscomplete/${itemId}`, {
                method: "PUT",
            });
    ...
    const deleteItem = async (itemId) => {
        try {
            const response = await fetch(`https://to-do-list-j6cu.onrender.com/auth/delete/${itemId}`, {
                method: "DELETE",
            });
    ...
    const handleUpdate = async (itemId) => {
        try {
            const response = await fetch(`https://to-do-list-j6cu.onrender.com/update/${itemId}`, {
                method: "PUT",
                headers: {
